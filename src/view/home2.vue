...
<!-- 				<mt-swipe :auto="4000">
				...
				<div  class="nut-swiper-slide gray" >
				    <a href="https://mp.weixin.qq.com/s/2pG4hrvpa8NrEdPh0B7Yhw" @click="goPage('','','网络英雄','2')"><img src="images/banner0916.png"/></a>
				</div>
				<div  class="nut-swiper-slide gray_1" >
				    <a @click="goPage('rules','','质检公告','3')"><img src="../assets/img/banner_zj.jpg"/></a>
				</div>
				<div  class="nut-swiper-slide gray" >
				    <a href="https://mp.weixin.qq.com/s/oIL_NKl1OF7qJHoloGYiXg" @click="goPage('','','网络王','4')"><img src="images/banner0917.jpg"/></a>
				</div>
				<div  class="nut-swiper-slide gray_1" >
					<a @click="goPage('days','24','8月优秀学员名单','5')"><img src="@/assets/static/banner0901.jpg"/></a>
				</div>				
					<div  class="nut-swiper-slide gray" >
					    <a @click="goPage('houseList','','竞拍广告位','6')"><img src="@/assets/static/banner-bz.png"/></a>
					</div>
				    <div  class="nut-swiper-slide gray" >
				        <a @click="goPage('days','30','经纪人接听标准','7')"><img src="@/assets/static/banner0531.png"/></a>
				    </div>
				    <div  class="nut-swiper-slide gray_1" >
				        <a @click="goPage('days','27','深圳二手房指导价','8')"><img src="@/assets/img/banner0222.jpg?v=1"/></a>
				    </div>
				</nut-swiper>
			</div>
		</div>
